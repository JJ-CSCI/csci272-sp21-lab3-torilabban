...
Quaternion  operator+ (const Quaternion& addie) const{
  ...
  addie.coeffe= this ->q.coeffe+addie.coeffe;
  addie.coeffe1= this ->q.coeffe1+addie.coeffe1;
  addie.coeffe2= this ->q.coeffe2 + addie.coeffe2;
  addie.coeffe3= this->q.coeffe3 + addie.coeffe3;
  return addie;
}
